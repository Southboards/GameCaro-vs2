...
/*
 * @brief check input is 1 or 2 or 3 or 4
 * @param str: string input
 */
 ...
 * @param str: string input
 */
void checkInvalid::checkInvalidCommandGame(string str)
{
    checkInvalidInteger(str);
    int command = stoi(str);
    if (command != 1 && command !=2 && command !=3 && command !=4)
...
void checkInvalid::checkInvalidNumberReplay(string numInput, int numGame)
{
    checkInvalidInteger(numInput);
